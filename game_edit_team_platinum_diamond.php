...
if(isset($_POST['selection'])){
	...
	//GET Platinum id and Diamond id
	$request = array();
	$request['query'] = "SELECT * FROM `customerteam` WHERE `ContestID`='".$contest_id."' AND `CustomerID`='".$Id."' AND `TeamID`='".$team_id."' AND `IsPrimaryCompany`='1'";
	...
	$platinum_id = $result_array['data'][0]['CompanyID'];
	
	$request = array();
	$request['query'] = "SELECT * FROM `customerteam` WHERE `ContestID`='".$contest_id."' AND `CustomerID`='".$Id."' AND `TeamID`='".$team_id."' AND `IsSecondaryCompany`='1'";
	...
	$diamond_id = $result_array['data'][0]['CompanyID'];
	
	$header = file_get_contents('templates/account/common/header.html');
	$dashboard = file_get_contents('templates/account/game_edit_team_platinum_diamond.html');
	$footer = file_get_contents('templates/account/common/footer_team_platinum_diamond_edit.html');
	...
	$game_team_link = BASE_URL.'game_edit_team.php?contest_id='.$contest_id.'&team_id='.$team_id;
