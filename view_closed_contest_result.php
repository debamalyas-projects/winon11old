...
$dashboard = file_get_contents('templates/account/close_contest.html');
...
for($i=0;$i<count($result_array2['data']);$i++){
	if($i%2==0){
		...
		$contest = file_get_contents('templates/account/contest_list_class.html');
	}
...
for($i=0,$k=1;$i<count($result_array['data']);$i++,$k++){
	if($i%2==0){
		$contest = $contest = file_get_contents('templates/account/leader_board.html');;
	}else{
		$contest = file_get_contents('templates/account/leader_board_class.html');
	}
	$tags_arr=array(
