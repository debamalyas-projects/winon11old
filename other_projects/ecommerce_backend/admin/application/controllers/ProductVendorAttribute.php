...
class ProductVendorUnit  extends BaseController
{
     ...
     */
    function addNewProductVendorUnit($vendor_id,$product_id,$unit_id)
    {
        if($this->isAdmin() == TRUE)
        {
            $this->loadThis();
        ...
        else
        {
			...
			$data['brandRecords'] = $this->attribute_model->getAllBrand();
			...
			$data['unitRecord'] = $this->productVendorUnit_model->getUnitInfo($data['unit_id']);
    ...
    function postProductVendorUnit()
    {
        ...
        else
        {
			...
			$this->form_validation->set_rules('attribute_id','Unit_id','required');
    ...
    function editProductVendorUnit()
    {
        ...
        else
        {
			...
			$this->form_validation->set_rules('attribute_id','Unit_id','trim|required|xss_clean');
			$this->form_validation->set_rules('type','Type','trim|required|xss_clean');
			$this->form_validation->set_rules('value','Value','trim|required|xss_clean');
			$this->form_validation->set_rules('price','Price','trim|required|xss_clean');
