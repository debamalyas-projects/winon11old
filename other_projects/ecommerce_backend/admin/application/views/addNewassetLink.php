            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addassetLink" action="<?php echo base_url() ?>postassetLink" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
								...
								<div class="col-md-6">                                
                                    <div class="form-group">
										...
										<textarea class="form-control required" id="link" name="link"></textarea>
                                    </div>     
                                </div>
                            </div>
...
<script src="<?php echo base_url(); ?>assets/js/addassetLink.js" type="text/javascript"></script>