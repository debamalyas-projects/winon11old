            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>editContent" method="post" id="editTenplate" role="form"
                            ...
                            <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="tag" name="tag" value="<?php echo $tag; ?>">
...
<script src="<?php echo base_url(); ?>content/js/editTenplate.js" type="text/javascript"></script>