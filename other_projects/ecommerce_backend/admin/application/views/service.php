                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
						  ...
						  <a class="btn btn-sm btn-info" href="<?php echo base_url().'viewServiceOld/'.$record->id; ?>"><i class="fa fa-eye"></i></a>
                          <a class="btn btn-sm btn-danger changeStatusService" href="javascript:void(0);" data-serviceid="<?php echo $record->id; ?>">
							<?php
								if($record->status==1){
									echo "Disable";
								}else{
