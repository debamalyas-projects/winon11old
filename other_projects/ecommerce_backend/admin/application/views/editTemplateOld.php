            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>editTemplate" method="post" id="editTenplate" role="form"
                            ...
                            <div class="row">
                                <div class="col-md-12">                                
                                    ...
                                    <div class="form-group">
										...
										<textarea class="form-control" id="html" name="html" rows="100" cols="50"><?php echo $html; ?></textarea>
										<input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
...
<script src="<?php echo base_url(); ?>template/js/editTenplate.js" type="text/javascript"></script>