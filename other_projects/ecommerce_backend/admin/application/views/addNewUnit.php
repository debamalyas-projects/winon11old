            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUnit" action="<?php echo base_url() ?>postUnit" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">                                
...
<script src="<?php echo base_url(); ?>assets/js/addUnit.js" type="text/javascript"></script>