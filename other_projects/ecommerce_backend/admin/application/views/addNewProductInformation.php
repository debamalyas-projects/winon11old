              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                     ...
                     <form role="form" id="addVendorProduct" action="<?php echo base_url() ?>postProductInformation" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
										...
										<select class="form-control required" id="product_id" name="product_id">
											...
											?>
												<option value="<?php echo $productRecords[$i]->id; ?>"><?php echo $productRecords[$i]->name; ?></option>
											<?php
											}
											?>
										</select>
