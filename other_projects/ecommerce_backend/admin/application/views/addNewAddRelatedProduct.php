<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
		...
		<a class="btn btn-sm btn-info" href="<?php echo base_url().'addRelatedProductListing/'.$product_id.'/0';?>">Add Related Product Listing</a>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                     ...
                     <form role="form" id="addProductBrand" action="<?php echo base_url() ?>postAddRelatedProduct" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">                                
