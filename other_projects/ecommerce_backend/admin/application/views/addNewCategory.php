<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
		...
		<a class="btn btn-sm btn-info" href="<?php echo base_url().'categoryListing/';?>">Delivery Person Management Listing</a>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addCategory" action="<?php echo base_url() ?>postCategory" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
