            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addAsset" action="<?php echo base_url() ?>postAsset" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
...
<script src="<?php echo base_url(); ?>assets/js/addAsset.js" type="text/javascript"></script>