              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Reviewer Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="addReview" action="<?php echo base_url() ?>postReview" method="post" role="form">
                        <div class="box-body">
						<div class="row">
                                <div class="col-md-12">                                
							...
							<div class="row">
								...
								<div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="message" name="message">
                                    </div>
                                </div>
							</div>
